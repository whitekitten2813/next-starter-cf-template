    ...
    return (
        <>
            ...
            <main className="overflow-x-hidden">
                <section>
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44 font-[family-name:var(--font-geist-sans)]">
                    ...
                    <div className="group relative m-auto max-w-6xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm font-[family-name:var(--font-geist-sans)]">Powering the best teams</p>
                            </div>
